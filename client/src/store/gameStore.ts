...
const ALL_ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'dino_master',     title: 'Dino Master',              description: 'Score 500 in Dino Run.',                                icon: '🦕', points: 30, isUnlocked: false, category: 'gaming'  },
...
const ALL_GALLERY: GalleryItem[] = [
  ...
  { id: 'dino_master',     title: 'Dino Master 🦕',           description: 'A pixel art dinosaur jumping over cactus.', imageUrl: 'https://api.dicebear.com/7.x/shapes/svg?seed=DinoRun&backgroundColor=1a1a1a', unlockCondition: 'Unlock: Score 500 in Dino Run.', isUnlocked: false },
...
const ALL_GAME_IDS = ['flappyBird', 'snake', 'ticTacToe', 'memoryGame', 'puzzle2048', 'sudoku', 'neonSequence', 'spaceDodger', 'brickBreaker', 'whackABug', 'reactionGame', 'catchMyHeart', 'relationshipTrivia', 'cupShuffle', 'dinoRun'];
...
export const useGameStore = create<GameStoreState>((set, get) => ({
  ...
  saveGameScore: async (userId, displayName, gameId, score) => {
    try {
      ...
      if (gameId === 'dinoRun'            && score >= 500) unlock('dino_master');
