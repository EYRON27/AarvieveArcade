...
const GAMES_LIST: GameItem[] = [
  ...
  { id: 'dinoRun',            title: 'Dino Run',            icon: '🦕', category: 'retro', difficulty: 'Hard',   approxTime: '2 min',    tag: 'ACTION',  accentColor: 'border-arcade-green/30 hover:border-arcade-green text-arcade-green' },
];
